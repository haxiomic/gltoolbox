...
import nucleus.gl.GLFramebuffer;
import nucleus.gl.GLTexture;
import nucleus.math.Color;
import nucleus.render.RenderTools;
import nucleus.TextureTools;
import nucleus.TextureTools.TextureFactory;
...
class RenderTarget implements IRenderTarget{
	...
	public inline function resize(width:Int, height:Int):Void{
		...
		if(this.texture != null){
			var resampler = nucleus.shaders.Resample.instance;
