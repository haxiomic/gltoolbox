...
abstract Orientation(OrientationType) from OrientationType to OrientationType {
	...
	public function new(o:Orientation){
		this = o;
	}

	public function setFromOrientation(o:Orientation):Orientation{
		switch o{
	...
	public function setFromQuat(sq:Quat):Orientation{
		switch this{
	...
	public function setFromEuler(se:Euler):Orientation{
		switch this{
	...
	public function setFromMat4(sm:Mat4):Orientation{
		switch this{
